/* Kmeans algorithm implementation on a 1-dimensional dataset to produce 2 clusters */
...
public class kmeans1d {
    ...
    public static void main(String[] args) throws Exception{
          ...
          BufferedReader br = new BufferedReader(new FileReader("path")); //path is the path of the 1- dimensional dataset
          String line = null;
          Scanner sc = null; 
